...
namespace api_bakum.Migrations
{
    ...
    [Migration("20180619124418_2018Juni1901")]
    partial class _2018Juni1901
    {
            ...
            modelBuilder.Entity("data_access.entities.BantuanHukum", b =>
                {
                    ...
                    b.HasIndex("StatusBantuanForeignKey")
                        .IsUnique()
                        .HasFilter("[StatusBantuanForeignKey] IS NOT NULL");
            ...
            modelBuilder.Entity("data_access.entities.BantuanHukum", b =>
                {
                    ...
                    b.HasOne("data_access.entities.StatusBantuan", "LastStatus")
                        .WithOne()
                        .HasForeignKey("data_access.entities.BantuanHukum", "StatusBantuanForeignKey");
                });
