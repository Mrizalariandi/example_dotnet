...
namespace api_bakum.Migrations
{
    ...
    [Migration("20180824144543_AttachmentWhenReply")]
    partial class AttachmentWhenReply
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("data_access.entities.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<string>("UISRef");

                    b.HasKey("Id");

                    b.HasIndex("FKParentMenu");

                    b.ToTable("Menus");
                });

            modelBuilder.Entity("data_access.entities.MenuRoles", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("data_access.entities.Menu", b =>
                {
                    b.HasOne("data_access.entities.Menu", "ParentMenu")
                        .WithMany()
                        .HasForeignKey("FKParentMenu");
                });

            modelBuilder.Entity("data_access.entities.MenuRoles", b =>
                {
                    b.HasOne("data_access.entities.Menu", "Menu")
                        .WithMany()
                        .HasForeignKey("FKParentMenu");
